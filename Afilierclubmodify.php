<?php
	session_start();
	require 'vendors/php/fonctions/Afiliereclubmodify.php';
					...
					<div class="pd-20 mb-30 container">
						<div class="clearfix">
							<div class="pull-left container">
								<h4 class="text-blue">Modifier une Filiere</h4>
								<br>
								<?php
								if (isset($result)) {
									if ($result) {
						...
						<form action="Afilierclubmodify.php" method="POST" id="form">
