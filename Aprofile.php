	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30" style="width: 100px;">
						<div class="pd-20 card-box height-100-p row container block">
							<div class="profile-photo width col-4" style="min-height:400px;">
							...
							<?php 
								include 'vendors/php/fonctions/Aupdateprofil.php';
							?>
							<div class=" col-8 row">
								<div class="profile-info col-xl-5 col-lg-5 col-md-5 col-sm-12 mb-10">
										...
										<section style="padding: 5%;" id="sec1">
											<div class="form-wrap max-width-600 mx-auto">
												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control" name="surname" value = "<?php echo $username; ?>">
													</div>
												</div>
												<div class="form-group row">
