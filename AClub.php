<?php
session_start();
require 'vendors/php/fonctions/AClub.php';
			...
			<div class="page-header" style="padding: 1%;">
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="title">
							<h5>Clubs de filiere</h5>
						</div>
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Acceuil</a></li>
								<li class="breadcrumb-item active text-blue" aria-current="page">Clubs de filiere</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<div class="pd-20 mb-30 container">
					<div class="clearfix">
						<div class="pull-left container">
							<h4 class="mb-20 text-blue">Nouveau Club</h4>
							<div class="mb-20">
								<?php
								if (isset($result)) {
									if ($result) {
					...
					<form action="AClub.php" method="POST" id="form">
						<div class="form-group">
							<label class="col-sm-12 col-md-2 col-form-label">Filiere</label>
							<div class="col-sm-12 col-md-10">
								<select id="filiere" class="form-control" required="required" name="nomFiliere">
									<?php
										AllFiliere($result2);
									?>
								</select>
						...
						<div class="form-group">
							<label class="col-sm-12 col-md-2 col-form-label">Nom du club</label>
							<div class="col-sm-12 col-md-10">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input type="text" name="nomclub" class="form-control <?php cygleclub_error($cygleclub); ?>" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Cygles</label>
