			...
			<div class="min-height-200px">
				...
				<div class="row" style="padding-left: 2%;">
						<?php
							...
							$request ="SELECT P.id,title,datepub,categorie,nbVues,nbLikes FROM publications P, responsable R WHERE P.author_id = R.id AND R.name_Respo = 'RespoClasse' AND P.cible='$classe'";
