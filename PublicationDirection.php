			...
			<div class="min-height-200px">
				...
				<div class="row" style="padding-left: 2%;">
						<?php
							...
							$request ="SELECT P.id,title,datepub,categorie,nbVues,nbLikes FROM publications P, responsable R WHERE P.author_id = R.id AND R.name_Respo = 'Direction' AND (P.cible = 'A TOUS' OR P.cible='$classe')";
							if(!$result=$id->query($request))
							{
								echo 'Erreur de Chargement Veuillez reactualiser la page';
